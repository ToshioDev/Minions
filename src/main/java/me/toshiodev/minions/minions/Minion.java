    ...
    public ArrayList<MinionTier> getTiers(Minion minion){
        ...
        switch (minion.getName()){
            case "cobblestone":
                ...
                description = (ArrayList<String>) asList("§7Place this minion and it will","§7start generating and mining","§7cobblestone! Requires an open","§7area to place cobblestone.","§7Minions also work when you are offline!");
            ...
            case "coal":
                ...
                description = (ArrayList<String>) asList("§7Place this minion and it will","§7start generating and mining coal","§7ore! Requires an open area to","§7place coal ore. Minions also","§7work when you are offline");
            ...
            case "iron":
                ...
                forCrafts = new boolean[]{false,false,false,false,false,false,false,false,false,false,true,true};
                description = (ArrayList<String>) asList("§7Place this minion and it will","§7start generating and mining iron","§7ore! Requires an open area to","§7place iron ore. Minions also","7work when you are offline!");
            ...
            case "gold":
                ...
                forCrafts = new boolean[]{false,false,false,false,false,false,false,false,false,false,true,true};
                description = (ArrayList<String>) asList("§7Place this minion and it will","§7start generating and mining gold","§7ore! Requires an open area to","§7place gold ore. Minions also","7work when you are offline!");
            ...
            case "diamond":
                ...
                forCrafts = new boolean[]{false,false,false,false,false,false,false,false,false,false,true,true};
                description = (ArrayList<String>) asList("§7Place this minion and it will","§7start generating and mining diamond","§7ore! Requires an open area to","§7place diamond ore. Minions also","7work when you are offline!");
            ...
            case "lapis":
                ...
                forCrafts = new boolean[]{false,false,false,false,false,false,false,false,false,false,true,true};
                description = (ArrayList<String>) asList("§7Place this minion and it will","§7start generating and mining lapis","§7ore! Requires an open area to","§7place lapis ore. Minions also","7work when you are offline!");
            ...
            case "emerald":
                ...
                forCrafts = new boolean[]{false,false,false,false,false,false,false,false,false,false,true,true};
                description = (ArrayList<String>) asList("§7Place this minion and it will","§7start generating and mining emerald","§7ore! Requires an open area to","§7place emerald ore. Minions also","7work when you are offline!");
            ...
            case "redstone":
                ...
                description = (ArrayList<String>) asList("§7Place this minion and it will","§7start generating and mining redstone","§7ore! Requires an open area to","§7place redstone ore. Minions also","7work when you are offline!");
            ...
            case "quartz":
                ...
                forCrafts = new boolean[]{false,false,false,false,false,false,false,false,false,false,false,true};
                description = (ArrayList<String>) asList("§7Place this minion and it will","§7start generating and mining","§7quartz ore! Requires an open","§7area to place quartz ore.","§7Minions also work when you are offline!");
            ...
            case "obsidian":
                ...
                forCrafts = new boolean[]{false,false,false,false,false,false,false,false,false,false,false,true};
                description = (ArrayList<String>) asList("§7Place this minion and it will","§7start generating and mining","§7obsidian! Requires an open area","§7to place obsidian. Minions also","§7work when you are offline");
            ...
            case "glowstone":
                ...
                description = (ArrayList<String>) asList("§7Place this minion and it will","§7start generating and mining","§7glowstone! Requires an open area","§7to place glowstone. Minions also","§7work when you are offline");
            ...
            case "gravel":
                ...
                description = (ArrayList<String>) asList("§7Place this minion and it will","§7start generating and mining","§7gravel! Requires an open area to","§7place gravel. Minions also work","§7when you are offline");
            ...
            case "ice":
                ...
                description = (ArrayList<String>) asList("§7Place this minion and it will","§7start generating and mining ice!","§7Requires an open area to place","§7ice. Minions also work when you","§7are offline");
            ...
            case "sand":
                ...
                forCrafts = new boolean[]{false,false,false,false,false,false,false,false,false,false,false};
                description = (ArrayList<String>) asList("§7Place this minion and it will","§7start generating and mining","§7sand! Requires an open area to","§7place sand. Minions also work","§7when you are offline");
            ...
            case "end_stone":
                ...
                forCrafts = new boolean[]{false,false,false,false,false,false,false,false,false,false,false};
                description = (ArrayList<String>) asList("§7Place this minion and it will","§7start generating and mining end","§7stone!","§7Requires an open area to","§7place end stone. Minions also","§7work when you are offline");
            ...
            case "mithril":
                ...
                forCrafts = new boolean[]{false,false,false,false,false,false,false,false,false,false,true,true};
                description = (ArrayList<String>) asList("§7Place this minion and it will","§7start generating and mining Mithril!","§7Requires an open area to","§7place Mithril. Minions also","§7work when you are offline");
            ...
            case "hard_stone":
                cooldowns = new double[]{14,14,12,12,10,10,9,9,8,8,7,6};
                forCrafts = new boolean[]{false,false,false,false,false,false,false,false,false,true,true,true};
                description = (ArrayList<String>) asList("§7Place this minion and it will","§7start generating and mining Hard","§7Stone! Requires an open area to","§7place Hard Stone. Minions also","§7work when you are offline");
